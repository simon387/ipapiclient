...
public class RestApiCaller {
	...
	private static void sendPutRequest ( String endpoint, int minutes ) throws Exception {
		var connection = getHttpURLConnection ( endpoint );
		...
		var message = String.format ( "%s Sent request to: %s, response code: %d, next call in %d minutes. %s",
						now (), endpoint, responseCode, minutes, response );
